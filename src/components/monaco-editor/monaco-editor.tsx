...
function createOwnedModel(
  ...
  const model = monaco.editor.createModel(
    value,
    controller.currentProps.language,
    uri
  );
...
function runMountHandler(
  handler: MonacoMountHandler,
  controller: MonacoController
) {
...
async function ensureEditor(
  ...
  controller.lastOverflowWidgetsDomNode =
    controller.currentProps.options?.overflowWidgetsDomNode;
  controller.lastAriaContainerElement =
    controller.currentProps.options?.ariaContainerElement;
...
export function MonacoEditor(props: MonacoEditorProps): JSX.Element {
  const controllerState = state(createController(props));
